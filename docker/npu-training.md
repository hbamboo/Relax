...
| -------- | -------- | ---- | ----- | ---------------- | ------------------------------------------------------- |
| Qwen3-4B | DAPO     | √    | √     | 910C 4卡         | `scripts/training/text/run-qwen3-4B-4xnpu-colocate.sh` |
| Qwen3.5-4B | DAPO     | √    | √     | 910C 4卡         | `scripts/training/text/run-qwen35-9B-4xnpu-colocate.sh` |
